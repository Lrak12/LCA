...
const ARTICLES = [
  ...
  { icon: "fact_check", iconBg: "bg-purple-100", iconColor: "text-purple-600",
    ...
    body:  "Open Record Assessments, pick a student, and record scores per PACE. Self-Tests pass at 80 and above; official PACE Tests pass at 90 and above. A student must have at least one passing Self-Test attempt before the PACE Test unlocks. PACE Test scores are the official results that count toward the grade." },
  ...
  { icon: "speed", iconBg: "bg-orange-100", iconColor: "text-orange-600",
    ...
    body:  "A student is 'PACE Test Ready' for a subject when any Self-Test attempt reaches 80. On completion, a PACE is marked On Time if finished by its expected end date, Extended if an extension was granted, or Late otherwise — this drives the performance points used in analytics." },
