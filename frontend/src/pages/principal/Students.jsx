          ...
          <div className="flex items-center gap-4 px-6 py-4 border-b border-outline-variant/20 flex-wrap">
            <div className="relative flex-1 min-w-[200px]">
              ...
              <input
                ...
                className="w-full pl-9 pr-9 py-2 text-sm bg-surface-container-low border border-outline-variant/30 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/30"
              />
              ...
              {search && (
                <button
                  ...
                  className="material-symbols-outlined absolute right-2.5 top-1/2 -translate-y-1/2 text-base text-on-surface-variant hover:text-on-surface cursor-pointer leading-none"
                >close</button>
              )}
            </div>
