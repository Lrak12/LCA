...
// Rendered by <RecordDiagnostic> (showMathBeginner). onClose = () => setShowMathBeginner(false);
// onSaved = handleMathBegSaved (closes the modal + reloads the student's diagnostics).
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 px-4">
      <div className="bg-white w-full max-w-3xl rounded-xl shadow-2xl overflow-hidden max-h-[95vh] flex flex-col">
        ...
        <div className="bg-primary px-4 sm:px-8 py-4 flex items-center justify-between shrink-0">
          <h2 className="text-white font-bold text-lg tracking-widest uppercase">Math Beginner</h2>
